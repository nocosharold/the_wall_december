document.addEventListener("DOMContentLoaded", () => {
    ...
    post_form.addEventListener("submit", postTopic);
});
...
/**
 * DOCU: It takes the value of the response textarea, creates a new response wrapper element, and appends the <br>
...
/**
 * DOCU: When Clicked. It removes the closest topic_container to the topic_yes_btn <br>
